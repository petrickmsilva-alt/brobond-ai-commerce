/**
 * TikTok Trend Collector — PLACEHOLDER (PR002.1).
 *
 * Reserved for the real TikTok source (PR003+): trending hashtags/keywords
 * via the TikTok API or scraping. The contract is already pinned here and
 * tested, so wiring the real implementation must not touch any caller —
 * `getCollector(TrendSource.TIKTOK)` keeps resolving to this class until
 * then.
 *
